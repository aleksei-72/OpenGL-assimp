...
int Shader::LoadFromFile(const GLchar* vertexPath, const GLchar* geometryPath, const GLchar* fragmentPath)
{
    ...
    string svertexPath = string(pathSettings.basePath + pathSettings.shaderPath + string(vertexPath)).c_str();
    string sgeometryPath = string(pathSettings.basePath + pathSettings.shaderPath + string(geometryPath)).c_str();
    string sfragmentPath = string(pathSettings.basePath + pathSettings.shaderPath + string(fragmentPath)).c_str();
